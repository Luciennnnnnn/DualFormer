...
from basicsr.models.sr_sgd_model import SRSimpleGatedDegradationModel

@MODEL_REGISTRY.register()
class SRGANSimpleGatedDegradationModel(SRSimpleGatedDegradationModel):
    """SRGANSimpleGatedDegradationModel model for single image super-resolution under simple gated degradation model."""
    ...
    def init_training_settings(self):
        ...
        if train_opt.get('peg_opt'):
            self.cri_peg = build_loss(train_opt['peg_opt']).to(self.device)
        else:
            self.cri_peg = None
