...
from basicsr.models.sr_hgd_model import SRHardGatedDegradationModel

@MODEL_REGISTRY.register()
class SRGANHardGatedDegradationModel(SRHardGatedDegradationModel):
    """SRGANHardGatedDegradationModel model for single image super-resolution under hard gated degradation model."""
